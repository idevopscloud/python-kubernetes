...
class ContainerSpec:
    def __init__(self, json):
        ...
        try:
            self.MemRequest = self.__convert_mem_str_to_int__(json['resources']['requests']['memory'])
        except KeyError as e:
            self.MemRequest = self.MemLimit
...
class Pod(TypeMeta):
    ...
    def MemRequest(self):
        ...
        for containerSpec in self.ContainerSpecs:
            mem_request = mem_request + containerSpec.MemRequest
